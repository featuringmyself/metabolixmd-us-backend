    ...
    bufferStream
        ...
        const proData = results.map(pro => {
            return {
                ...
                unit:pro.UNIT,
                image:{
                    url:pro.IMAGE ? `https://indiadrugmartapp.s3.eu-north-1.amazonaws.com/public/thumbnail/${pro.IMAGE}.jpg` : "https://indiadrugmartapp.s3.eu-north-1.amazonaws.com/public/thumbnail/pina-messina-kfJkpeI6Lgc-unsplash.jpg"
                },
